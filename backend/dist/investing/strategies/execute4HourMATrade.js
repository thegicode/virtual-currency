...
function scheduleMovingAverageTrades(markets, movingAveragePeriod) {
    return __awaiter(this, void 0, void 0, function* () {
        let executionCount = 0;
        const chatIds = (yield (0, notifications_1.getChatIds)());
        yield executeAndNotifyInterval();
        setInterval(executeAndNotifyInterval, 1000 * 60 * 240);
        function executeAndNotifyInterval() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    executionCount++;
                    yield executeAndNotify(movingAveragePeriod, executionCount, markets, chatIds);
                }
                catch (error) {
...
function executeAndNotify(movingAveragePeriod, executionCount, markets, chatIds) {
    return __awaiter(this, void 0, void 0, function* () {
        const tradeInfos = yield getTradeInfos(markets, movingAveragePeriod);
        const message = formatTradeInfosMessage(tradeInfos, executionCount);
        console.log(message);
    });
}
function getTradeInfos(markets, movingAveragePeriod) {
    return __awaiter(this, void 0, void 0, function* () {
        const promises = markets.map((market) => __awaiter(this, void 0, void 0, function* () {
            const candles = yield (0, api_1.fetchMinutes)(market, "240", movingAveragePeriod.toString());
...
function formatTradeInfosMessage(tradeInfos, executionCount) {
...
신호: ${info.signal}`)
        .join("\n\n");
    return `\n 🔔 4시간 캔들의 ${executionCount + 1}번째 이동평균 전략 실행 🔔\n\n${message}\n`;
}

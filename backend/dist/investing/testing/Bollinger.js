"use strict";
{
    ...
    function backtestBollingerBands(data, initialCapital) {
    ...
    const finalCapitalBollingerBands = bollingerBandsResult[bollingerBandsResult.length - 1].capital;
    const returnRateBollingerBands = (finalCapitalBollingerBands / initialCapital - 1) * 100;

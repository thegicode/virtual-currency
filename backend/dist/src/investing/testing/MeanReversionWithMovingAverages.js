"use strict";
{
    ...
    function calculateMeanReversionWithMovingAverages(data, shortPeriod, longPeriod) {
    ...
    function backtestMeanReversionWithMovingAverages(data, initialCapital) {
    ...
    const meanReversionWithMAResult = backtestMeanReversionWithMovingAverages(data, initialCapital);
    const finalCapitalMeanReversionWithMA = meanReversionWithMAResult[meanReversionWithMAResult.length - 1].capital;
    const returnRateMeanReversionWithMA = (finalCapitalMeanReversionWithMA / initialCapital - 1) * 100;

"use strict";
{
    ...
    function calculateMeanReversion(data, n) {
    ...
    function backtestMeanReversion(data, initialCapital) {
    ...
    const finalCapitalMeanReversion = meanReversionResult[meanReversionResult.length - 1].capital;
    const returnRateMeanReversion = (finalCapitalMeanReversion / initialCapital - 1) * 100;

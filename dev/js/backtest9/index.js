...
(() => {
  ...
  // dev/scripts/pages/backtest9/AppBacktest9.js
  ...
  var AppBacktest9 = class extends HTMLElement {
    constructor() {
      super();
      this.markets = [
        "KRW-BTC",
    ...
    backtest(fetchedData, orginRealPrices) {
      ...
      const strategedData = this.processTradingDecisions(volumedData, orginRealPrices);
    ...
    processTradingDecisions(fetchedData, realPrices) {
      ...
      const result = relevantData.map((candleData, index) => {
        ...
        const isVolumeAboveMovingAverage = this.checkOverVolumeAverage(candleData, previousCandle);
        ...
        const tradeCondition = Boolean(isOverMovingAverage && isVolumeAboveMovingAverage && isBreakout);
    ...
    checkOverVolumeAverage(candleData, previousCandle) {
      if (!candleData.volume_average_5)
        return null;
      return previousCandle.candle_acc_trade_volume > candleData.volume_average_5;
    }
  ...
  // dev/scripts/pages/backtest9/Overview.js
  var Overview = class extends HTMLElement {
    constructor() {
      super();
      this.app = document.querySelector("app-backtest9");
      this.data = [];
      this.profit = 0;
  ...
  // dev/scripts/pages/backtest9/Control.js
  ...
  // dev/scripts/pages/backtest9/Table.js
  ...
  // dev/scripts/pages/backtest9/index.js
  ...
  customElements.define("app-backtest9", AppBacktest9);
})();

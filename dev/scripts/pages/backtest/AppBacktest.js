...
export default class AppBacktest extends HTMLElement {
    ...
    createItem(aData) {
        ...
        if (!aData.moving_average_5)
            return cloned;
        const parseData = Object.assign(Object.assign({}, aData), { candle_date_time_kst: aData.candle_date_time_kst.replace("T", " "), opening_price: aData.opening_price.toLocaleString(), trade_price: aData.trade_price.toLocaleString(), moving_average_5: aData.moving_average_5 &&

...
import { setMovingAverage, setVolumeAverage, } from "@app/scripts/components/backtest/movingAverage";
...
export default class AppBacktest9 extends HTMLElement {
    ...
    processTradingDecisions(fetchedData, realPrices) {
        ...
        const result = relevantData.map((candleData, index) => {
            ...
            const tradeCondition = Boolean(isOverMovingAverage &&
...
//# sourceMappingURL=AppBacktest9.js.map